...
Tela de cadastros dos produtos
-->
...
<form method="POST" action="/gerenciar" id="produtos">
@if(Session::has('messagem'))
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            value="{{ old('titulo') }}" placeholder="titulo">
            @error('titulo')
        ...
        <div class="form-group col-md-6">
            ...
            autocomplete="off"  class="form-control @error('valor') is-invalid @enderror" value="{{ old('valor') }}">
            @error('valor')
            <div class="invalid-feedback" rule="alert">
                <strong>{{ $message }}</strong>
            </div>
        ...
        <div class="form-group col-md-6">
            ...
            autocomplete="off" value="{{ old('quantidade') }}" class="form-control @error('quantidade') is-invalid @enderror"   >
            @error('quantidade')
            <div class="invalid-feedback" rule="alert">
                <strong>{{ $message }}</strong>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea type="descricao" placeholder="descricao" name="descricao" value="{{ old('descricao') }}" rows="5"
            autocomplete="off"  class="form-control @error('descricao') is-invalid @enderror" style="resize:none;"></textarea>
            @error('descricao')
            <div class="invalid-feedback" rule="alert">
                <strong>{{ $message }}</strong>
            </div>
